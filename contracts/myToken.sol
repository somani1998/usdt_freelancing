...
contract USDTToken is Context, Ownable, Staking {
    /**
    ...
    function transferFrom(
        ...
        require(
            ...
            "Flamingo: transfer exceeds allowance"
        );
    ...
    function _transfer(
        ...
        require(
            sender != address(0),
            "Flamingo: transfer from the zero address"
        );
        require(
            recipient != address(0),
            "Flamingo: transfer to the zero address"
        );
        require(
            _balances[sender] >= amount,
            "Flamingo: Transfer amount exceeds balance"
        );
